import{B as e,M as t,V as n,b as r,g as i,r as a,u as o,w as s}from"./ModalController-KQ_YxXdx.js";import{S as c,f as l,g as u,l as d,n as f,o as p,t as m}from"./exports-OzXcm-9f.js";import{c as h,o as g,s as _}from"./wui-text-JiSAUhpb.js";import"./wui-image-CPInvSw0.js";import"./wui-icon-box-Jm99dBYq.js";import"./wui-shimmer-BAnohvHf.js";import"./wui-link-DRmX1H6G.js";import"./wui-icon-box-D9yPdlpu.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
...
`,N=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},P=`last-transaction`,F=7,I=class extends l{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page=`activity`,this.caipAddress=a.state.activeCaipAddress,this.transactionsByYear=o.state.transactionsByYear,this.loading=o.state.loading,this.empty=o.state.empty,this.next=o.state.next,o.clearCursor(),this.unsubscribe.push(a.subscribeKey(`activeCaipAddress`,e=>{e&&this.caipAddress!==e&&(o.resetTransactions(),o.fetchTransactions(e)),this.caipAddress=e}),a.subscribeKey(`activeCaipNetwork`,()=>{this.updateTransactionView()}),o.subscribe(e=>{this.transactionsByYear=e.transactionsByYear,this.loading=e.loading,this.empty=e.empty,this.next=e.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u` ${this.empty?null:this.templateTransactionsByYear()}
    ...
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){o.resetTransactions(),this.caipAddress&&o.fetchTransactions(n.getPlainAddress(this.caipAddress))}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(e=>{let t=parseInt(e,10),n=Array(12).fill(null).map((e,n)=>({groupTitle:f.getTransactionGroupTitle(t,n),transactions:this.transactionsByYear[t]?.[n]})).filter(({transactions:e})=>e).reverse();return n.map(({groupTitle:e,transactions:t},r)=>{let i=r===n.length-1;return t?u`
          <wui-flex
