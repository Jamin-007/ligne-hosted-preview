import{B as e,M as t,b as n,g as r,r as i,w as a}from"./ModalController-KQ_YxXdx.js";import{f as o,g as s,i as c,l,o as u,t as d,x as f}from"./exports-OzXcm-9f.js";import{s as p}from"./wui-text-JiSAUhpb.js";import"./wui-icon-CC7Hfwzk.js";import"./wui-link-DRmX1H6G.js";var m=`https://reown.com`,h=l`
  .reown-logo {
    height: 24px;
  }
...
`,y=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},b=class extends o{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=t.state.remoteFeatures,this.unsubscribe.push(t.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:n}=t.state,r=t.state.features?.legalCheckbox;return!e&&!n||r?s`
    ...
    `}howDoesItWorkTemplate(){return s` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){a.sendEvent({type:`track`,event:`SELECT_WHAT_IS_A_BUY`,properties:{isSmartAccount:r(i.state.activeChain)===e.ACCOUNT_TYPES.SMART_ACCOUNT}}),n.push(`WhatIsABuy`)}};C.styles=[x],C=S([d(`w3m-onramp-providers-footer`)],C);