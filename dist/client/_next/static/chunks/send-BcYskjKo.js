import{E as e,O as t,U as n,V as r,at as i,b as a,c as o,et as s,i as c,j as l,l as u,r as d,t as f,w as p}from"./ModalController-KQ_YxXdx.js";import{f as m,g as h,i as g,l as _,o as v,r as y,t as b}from"./exports-OzXcm-9f.js";import{t as x}from"./SwapController-BipbHG4W.js";import{c as S,o as C,s as w}from"./wui-text-JiSAUhpb.js";import"./wui-button-DzuYjpBE.js";import"./wui-icon-CC7Hfwzk.js";import"./wui-image-CPInvSw0.js";import"./wui-separator-BUw-dPV9.js";import{n as T,t as E}from"./ref-C6YPRynk.js";import"./wui-link-DRmX1H6G.js";import"./wui-icon-box-D9yPdlpu.js";import"./wui-avatar-CGaoguZp.js";import"./wui-list-token-DALp2V9D.js";import"./wui-input-text-C9uVIgNP.js";import"./wui-input-amount-Dl3xI5Em.js";import"./wui-token-button-NArBzTcf.js";var D=_`
  :host {
    width: 100%;
    height: 100px;
...
`,O=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},k=class extends m{constructor(){super(...arguments),this.inputElementRef=E(),this.instructionElementRef=E(),this.readOnly=!1,this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=r.debounce(async e=>{if(!e.length){this.setReceiverAddress(``);return}let t=d.state.activeChain;if(r.isAddress(e,t)){this.setReceiverAddress(e);return}try{let t=await u.getEnsAddress(e);if(t){c.setReceiverProfileName(e),c.setReceiverAddress(t);let n=await u.getEnsAvatar(e);c.setReceiverProfileImageUrl(n||void 0)}}catch{this.setReceiverAddress(e)}finally{c.setLoading(!1)}})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return this.readOnly?h` <wui-flex
    ...
    >
      ...
      <textarea
        ...
        autocomplete="off"
      ></textarea>
    </wui-flex>`}async focusInput(){this.instructionElementRef.value&&(this.instructionHidden=!0,await this.toggleInstructionFocus(!1),this.instructionElementRef.value.style.pointerEvents=`none`,this.inputElementRef.value?.focus(),this.inputElementRef.value&&(this.inputElementRef.value.selectionStart=this.inputElementRef.value.selectionEnd=this.inputElementRef.value.value.length))}async focusInstruction(){this.instructionElementRef.value&&(this.instructionHidden=!1,await this.toggleInstructionFocus(!0),this.instructionElementRef.value.style.pointerEvents=`auto`,this.inputElementRef.value?.blur())}async toggleInstructionFocus(e){this.instructionElementRef.value&&await this.instructionElementRef.value.animate([{opacity:+!e},{opacity:+!!e}],{duration:100,easing:`ease`,fill:`forwards`}).finished}onBoxClick(){!this.value&&!this.instructionHidden&&this.focusInput()}onBlur(){!this.value&&this.instructionHidden&&!this.pasting&&this.focusInstruction()}checkHidden(){this.instructionHidden&&this.focusInput()}async onPasteClick(){this.pasting=!0;let e=await navigator.clipboard.readText();c.setReceiverAddress(e),this.focusInput()}onInputChange(e){let t=e.target;this.pasting=!1,this.value=e.target?.value,t.value&&!this.instructionHidden&&this.focusInput(),c.setLoading(!0),this.onDebouncedSearch(t.value)}setReceiverAddress(e){c.setReceiverAddress(e),c.setReceiverProfileName(void 0),c.setReceiverProfileImageUrl(void 0),c.setLoading(!1)}};k.styles=D,O([S()],k.prototype,`value`,void 0),O([S({type:Boolean})],k.prototype,`readOnly`,void 0),O([w()],k.prototype,`instructionHidden`,void 0),O([w()],k.prototype,`pasting`,void 0),k=O([b(`w3m-input-address`)],k);var A=_`
  :host {
    width: 100%;
    height: 100px;
    border-radius: ${({borderRadius:e})=>e[5]};
...
`,j=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},M=class extends m{constructor(){super(...arguments),this.readOnly=!1,this.isInsufficientBalance=!1}render(){let e=this.readOnly||!this.token;return h` <wui-flex
    ...
    </wui-flex>`}onInputChange(e){c.setTokenAmount(String(e.detail))}onMaxClick(){if(this.token){let e=Number(this.token.quantity.decimals),t=i.bigNumber(this.token.quantity.numeric);if(!this.token.address&&this.gasPrice){let n=65000n*BigInt(this.gasPrice),r=i.bigNumber(n.toString()).div(i.bigNumber(10).pow(e)),a=t.minus(r);c.setTokenAmount(a.gt(0)?a.toFixed(e,0):`0`)}else c.setTokenAmount(t.toFixed(e,0))}}};M.styles=A,j([S({type:Object})],M.prototype,`token`,void 0),j([S({type:Boolean})],M.prototype,`readOnly`,void 0),j([S({type:String})],M.prototype,`sendTokenAmount`,void 0),j([S({type:Boolean})],M.prototype,`isInsufficientBalance`,void 0),j([S({type:String})],M.prototype,`gasPrice`,void 0),M=j([b(`w3m-input-token`)],M);var N=_`
  :host {
    display: block;
  }
...
`,P=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},F={INSUFFICIENT_FUNDS:`Insufficient Funds`,INCORRECT_VALUE:`Incorrect Value`,INVALID_ADDRESS:`Invalid Address`,ADD_ADDRESS:`Add Address`,ADD_AMOUNT:`Add Amount`,SELECT_TOKEN:`Select Token`,PREVIEW_SEND:`Preview Send`},I=class extends m{constructor(){super(),this.unsubscribe=[],this.isTryingToChooseDifferentWallet=!1,this.token=c.state.token,this.sendTokenAmount=c.state.sendTokenAmount,this.receiverAddress=c.state.receiverAddress,this.receiverProfileName=c.state.receiverProfileName,this.loading=c.state.loading,this.params=a.state.data?.send,this.caipAddress=d.getAccountData()?.caipAddress,this.disconnecting=!1,this.gasFee=x.state.gasFee,this.token&&!this.params&&(this.fetchBalances(),this.fetchNetworkPrice());let e=d.subscribeKey(`activeCaipAddress`,t=>{!t&&this.isTryingToChooseDifferentWallet&&(this.isTryingToChooseDifferentWallet=!1,f.open({view:`Connect`,data:{redirectView:`WalletSend`}}).catch(()=>null),e())});this.unsubscribe.push(d.subscribeAccountStateProp(`caipAddress`,e=>{this.caipAddress=e}),c.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}),x.subscribeKey(`gasFee`,e=>{this.gasFee=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}async firstUpdated(){await this.handleSendParameters()}render(){let e=this.getMessage(),t=!!this.params;return h` <wui-flex flexDirection="column" .padding=${[`0`,`4`,`4`,`4`]}>
...
`,R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z=class extends m{constructor(){super(),this.unsubscribe=[],this.tokenBalances=c.state.tokenBalances,this.search=``,this.onDebouncedSearch=r.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(c.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return h`
    ...
    `}async fetchBalancesAndNetworkPrice(){(!this.tokenBalances||this.tokenBalances?.length===0)&&(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await c.fetchTokenBalance(),c.fetchNetworkBalance()}async fetchNetworkPrice(){await x.getNetworkTokenPrice()}templateSearchInput(){return h`
    ...
    `}onBuyClick(){a.push(`OnRampProviders`)}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){c.setToken(e),c.setTokenAmount(void 0),a.goBack()}};z.styles=L,R([w()],z.prototype,`tokenBalances`,void 0),R([w()],z.prototype,`tokens`,void 0),R([w()],z.prototype,`filteredTokens`,void 0),R([w()],z.prototype,`search`,void 0),z=R([b(`w3m-wallet-send-select-token-view`)],z);var B=_`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`,V=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},H=class extends m{constructor(){super(...arguments),this.text=``}render(){return h`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?h`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?h`<wui-image src=${this.imageSrc}></wui-image>`:h`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};H.styles=[v,g,B],V([S({type:String})],H.prototype,`text`,void 0),V([S({type:String})],H.prototype,`address`,void 0),V([S({type:String})],H.prototype,`imageSrc`,void 0),H=V([b(`wui-preview-item`)],H);var U=_`
  :host {
    display: flex;
...
`,q=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},J=class extends m{constructor(){super(...arguments),this.params=a.state.data?.send}render(){return h` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      <wui-flex flexDirection="column" gap="1">
        ...
        class="network"
        textTitle="Network"
        imageSrc=${C(e.getNetworkImage(this.caipNetwork))}
      ></wui-list-content>`:null}onNetworkClick(e){e&&!this.params&&a.push(`Networks`,{network:e})}};J.styles=K,q([S()],J.prototype,`receiverAddress`,void 0),q([S({type:Object})],J.prototype,`caipNetwork`,void 0),q([w()],J.prototype,`params`,void 0),J=q([b(`w3m-wallet-send-details`)],J);var Y=_`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`,X=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Z=class extends m{constructor(){super(),this.unsubscribe=[],this.token=c.state.token,this.sendTokenAmount=c.state.sendTokenAmount,this.receiverAddress=c.state.receiverAddress,this.receiverProfileName=c.state.receiverProfileName,this.receiverProfileImageUrl=c.state.receiverProfileImageUrl,this.caipNetwork=d.state.activeCaipNetwork,this.loading=c.state.loading,this.params=a.state.data?.send,this.unsubscribe.push(c.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),d.subscribeKey(`activeCaipNetwork`,e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return h` <wui-flex flexDirection="column" .padding=${[`0`,`4`,`4`,`4`]}>
    ...
    >`}sendValueTemplate(){return!this.params&&this.token&&this.sendTokenAmount?h`<wui-text variant="md-regular" color="primary"
      ...
      >`:null}async onSendClick(){if(!this.sendTokenAmount||!this.receiverAddress){l.showError(`Please enter a valid amount and receiver address`);return}try{await c.sendToken(),this.params?a.reset(`WalletSendConfirmed`):(l.showSuccess(`Transaction started`),a.replace(`Account`))}catch(e){let n=`Failed to send transaction`,r=e instanceof t&&e.originalName===s.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST,i=e instanceof t&&e.originalName===s.PROVIDER_RPC_ERROR_NAME.SEND_TRANSACTION_ERROR;(r||i)&&(n=e.message),p.sendEvent({type:`track`,event:r?`SEND_REJECTED`:`SEND_ERROR`,properties:c.getSdkEventProperties(e)}),l.showError(n)}}onCancelClick(){a.goBack()}};Z.styles=Y,X([w()],Z.prototype,`token`,void 0),X([w()],Z.prototype,`sendTokenAmount`,void 0),X([w()],Z.prototype,`receiverAddress`,void 0),X([w()],Z.prototype,`receiverProfileName`,void 0),X([w()],Z.prototype,`receiverProfileImageUrl`,void 0),X([w()],Z.prototype,`caipNetwork`,void 0),X([w()],Z.prototype,`loading`,void 0),X([w()],Z.prototype,`params`,void 0),Z=X([b(`w3m-wallet-send-preview-view`)],Z);var Q=_`
  .icon-box {
    width: 64px;
    height: 64px;
    border-radius: 16px;
