import{$ as e,N as t,S as n,W as r,g as i,z as a}from"./W3MFrameProviderSingleton-HZYm1xhS.js";import{f as o,g as s,i as c,l,o as u,t as d}from"./exports-C_Yj_olO.js";import{t as f}from"./ExchangeController-TxNqA9Rw.js";import{c as p,o as m,s as h}from"./wui-text-DGOaezhb.js";import"./wui-button-ji6liv2F.js";import"./wui-icon-Cn6lXW8X.js";import"./wui-icon-link-MRzZBd5X.js";import"./wui-image-B4Ze9tnj.js";import"./wui-image-CKXxvQUF.js";import"./wui-list-item-DjeT1u5G.js";import"./wui-separator-DS5VUdXc.js";import"./wui-shimmer-OAmtXZXc.js";import"./wui-link-D9BFVd_F.js";import"./wui-icon-box-BWGFHgZO.js";import"./wui-list-token-BJaNPB27.js";import"./wui-input-text-S0RbU_qH.js";import"./wui-input-amount-Bf6QvgU9.js";var g=l`
  button {
    border: none;
...
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w=[10,50,100],T=6,E=10,D=class extends o{constructor(){super(),this.unsubscribe=[],this.network=i.state.activeCaipNetwork,this.exchanges=f.state.exchanges,this.isLoading=f.state.isLoading,this.amount=f.state.amount,this.tokenAmount=f.state.tokenAmount,this.priceLoading=f.state.priceLoading,this.isPaymentInProgress=f.state.isPaymentInProgress,this.currentPayment=f.state.currentPayment,this.paymentId=f.state.paymentId,this.paymentAsset=f.state.paymentAsset,this.unsubscribe.push(i.subscribeKey(`activeCaipNetwork`,e=>{this.network=e,this.setDefaultPaymentAsset()}),f.subscribe(e=>{this.exchanges=e.exchanges,this.isLoading=e.isLoading,this.amount=e.amount,this.tokenAmount=e.tokenAmount,this.priceLoading=e.priceLoading,this.paymentId=e.paymentId,this.isPaymentInProgress=e.isPaymentInProgress,this.currentPayment=e.currentPayment,this.paymentAsset=e.paymentAsset,e.isPaymentInProgress&&e.currentPayment?.exchangeId&&e.currentPayment?.sessionId&&e.paymentId&&this.handlePaymentInProgress()}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),f.state.isPaymentInProgress||f.reset()}async firstUpdated(){await this.getPaymentAssets(),this.paymentAsset||await this.setDefaultPaymentAsset(),f.setAmount(w[0]),await f.fetchExchanges()}render(){return s`
      ...
      >
        ...
        >
          ...
          <wui-token-button
            ...
            size="lg"
            .chainImageSrc=${m(a.getNetworkImage(this.network))}
          >
          </wui-token-button>
        </wui-flex>
        <wui-flex
    ...
    `}async onExchangeClick(e){if(!this.amount){r.showError(`Please enter an amount`);return}await f.handlePayWithExchange(e.id)}handlePaymentInProgress(){let e=i.state.activeChain,{redirectView:a=`Account`}=t.state.data??{};this.isPaymentInProgress&&this.currentPayment?.exchangeId&&this.currentPayment?.sessionId&&this.paymentId&&(f.waitUntilComplete({exchangeId:this.currentPayment.exchangeId,sessionId:this.currentPayment.sessionId,paymentId:this.paymentId}).then(a=>{a.status===`SUCCESS`?(r.showSuccess(`Deposit completed`),f.reset(),e&&(i.fetchTokenBalance(),n.updateBalance(e)),t.replace(`Transactions`)):a.status===`FAILED`&&r.showError(`Deposit failed`)}),r.showLoading(`Deposit in progress...`),t.replace(a))}onAmountChange({detail:e}){f.setAmount(e?Number(e):null)}async getPaymentAssets(){this.network&&await f.getAssetsForNetwork(this.network.caipNetworkId)}async setDefaultPaymentAsset(){if(this.network){let e=await f.getAssetsForNetwork(this.network.caipNetworkId);e[0]&&f.setPaymentAsset(e[0])}}};D.styles=S,C([h()],D.prototype,`network`,void 0),C([h()],D.prototype,`exchanges`,void 0),C([h()],D.prototype,`isLoading`,void 0),C([h()],D.prototype,`amount`,void 0),C([h()],D.prototype,`tokenAmount`,void 0),C([h()],D.prototype,`priceLoading`,void 0),C([h()],D.prototype,`isPaymentInProgress`,void 0),C([h()],D.prototype,`currentPayment`,void 0),C([h()],D.prototype,`paymentId`,void 0),C([h()],D.prototype,`paymentAsset`,void 0),D=C([d(`w3m-deposit-from-exchange-view`)],D);var O=l`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},A=class extends o{constructor(){super(),this.unsubscribe=[],this.assets=f.state.assets,this.search=``,this.onDebouncedSearch=e.debounce(e=>{this.search=e}),this.unsubscribe.push(f.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
