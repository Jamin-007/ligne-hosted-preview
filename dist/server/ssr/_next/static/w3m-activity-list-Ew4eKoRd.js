import{$ as e,C as t,G as n,L as r,N as i,Q as a,g as o,k as s}from"./W3MFrameProviderSingleton-HZYm1xhS.js";import{S as c,f as l,g as u,l as d,n as f,o as p,t as m}from"./exports-C_Yj_olO.js";import{c as h,o as g,s as _}from"./wui-text-DGOaezhb.js";import"./wui-image-B4Ze9tnj.js";import"./wui-icon-box-D0yW0YS4.js";import"./wui-shimmer-DF7YjVJv.js";import"./wui-link-D9BFVd_F.js";import"./wui-icon-box-BWGFHgZO.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
...
`,N=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},P=`last-transaction`,F=7,I=class extends l{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page=`activity`,this.caipAddress=o.state.activeCaipAddress,this.transactionsByYear=t.state.transactionsByYear,this.loading=t.state.loading,this.empty=t.state.empty,this.next=t.state.next,t.clearCursor(),this.unsubscribe.push(o.subscribeKey(`activeCaipAddress`,e=>{e&&this.caipAddress!==e&&(t.resetTransactions(),t.fetchTransactions(e)),this.caipAddress=e}),o.subscribeKey(`activeCaipNetwork`,()=>{this.updateTransactionView()}),t.subscribe(e=>{this.transactionsByYear=e.transactionsByYear,this.loading=e.loading,this.empty=e.empty,this.next=e.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u` ${this.empty?null:this.templateTransactionsByYear()}
    ${this.loading?this.templateLoading():null}
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){t.resetTransactions(),this.caipAddress&&t.fetchTransactions(e.getPlainAddress(this.caipAddress))}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(e=>{let t=parseInt(e,10),n=Array(12).fill(null).map((e,n)=>({groupTitle:f.getTransactionGroupTitle(t,n),transactions:this.transactionsByYear[t]?.[n]})).filter(({transactions:e})=>e).reverse();return n.map(({groupTitle:e,transactions:t},r)=>{let i=r===n.length-1;return t?u`
          <wui-flex
